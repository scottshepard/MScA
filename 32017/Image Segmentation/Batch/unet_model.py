...
def unet_model(n_classes=5, im_sz=160, n_channels=8, n_filters_start=32, growth_factor=2, upconv=True,
               class_weights=[0.2, 0.3, 0.1, 0.1, 0.3], drop_rate = 0.2):
    n_filters = n_filters_start
    inputs = Input((im_sz, im_sz, n_channels))
    btch1 = BatchNormalization()(inputs)
    conv1 = Conv2D(n_filters, (3, 3), activation='relu', padding='same')(btch1)
    conv1 = Conv2D(n_filters, (3, 3), activation='relu', padding='same')(conv1)
    pool1 = MaxPooling2D(pool_size=(2, 2))(conv1)
    drop1 = Dropout(drop_rate)(pool1)

    n_filters *= growth_factor
    btch2 = BatchNormalization()(drop1)
    conv2 = Conv2D(n_filters, (3, 3), activation='relu', padding='same')(btch2)
    conv2 = Conv2D(n_filters, (3, 3), activation='relu', padding='same')(conv2)
    pool2 = MaxPooling2D(pool_size=(2, 2))(conv2)
    drop2 = Dropout(drop_rate)(pool2)

    n_filters *= growth_factor
    btch3 = BatchNormalization()(drop2)
    conv3 = Conv2D(n_filters, (3, 3), activation='relu', padding='same')(btch3)
    conv3 = Conv2D(n_filters, (3, 3), activation='relu', padding='same')(conv3)
    pool3 = MaxPooling2D(pool_size=(2, 2))(conv3)
    drop3 = Dropout(drop_rate)(pool3)

    n_filters *= growth_factor
    btch4 = BatchNormalization()(drop2)
    ...
    n_filters *= growth_factor
    btch4 = BatchNormalization()(drop4)
    ...
    btch6 = BatchNormalization()(up6)
    conv6 = Conv2D(n_filters, (3, 3), activation='relu', padding='same')(btch6)
    ...
    btch7 = BatchNormalization()(up7)
    conv7 = Conv2D(n_filters, (3, 3), activation='relu', padding='same')(btch7)
    ...
    btch8 = BatchNormalization()(up8)
    conv8 = Conv2D(n_filters, (3, 3), activation='relu', padding='same')(btch8)
    ...
    btch9 = BatchNormalization()(up9)
    conv9 = Conv2D(n_filters, (3, 3), activation='relu', padding='same')(btch9)
    conv9 = Conv2D(n_filters, (3, 3), activation='relu', padding='same')(conv9)
    drop9 = Dropout(drop_rate)(conv9)

    conv10 = Conv2D(n_classes, (1, 1), activation='sigmoid')(drop9)
